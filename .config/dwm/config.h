...
static const Rule rules[] = {
	...
	RULE(.class    = "arcolinux-logout", .isfloating = 1)
...
static Key keys[] = {
	...
	{ Mod1Mask,			XK_space,      spawn,		       SHCMD("rofi -show drun -show-icons")},
	//{ NULL,				XF86XK_AudioRaiseVolume,		       spawn,		       SHCMD("amixer -D pulse sset Master 5%+ && pkill -RTMIN+1 i3blocks")},
	//{ NULL,				XF86XK_AudioLowerVolume,            	       spawn,	               SHCMD("amixer -D pulse sset Master 5%- && pkill -RTMIN+1 i3blocks")},
	...
	{ MODKEY,                       XK_o,          spawn,                  {.v = lock } }, /* rofi clipboard */
	{ MODKEY,                       XK_x,          spawn,                  SHCMD("arcolinux-logout") }, /* activate inhibitor */
